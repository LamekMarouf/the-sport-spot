          ...
          <Link to="/notfound">
            <div className="picture-text">
              ...
              <div id="caption">
                ...
                and the oldest major professional sports league in the world.{" "}
              </div>
            </div>
            <img
              src={mlbLogo}
          ...
          <Link to="/footballpage">
            ...
            <div className="picture-text">
              ...
              <div id="caption">
                ...
                league in North America. The league is composed of 30 teams and
                is one of the major professional sports leagues in the United
                States and Canada. It is the premier men's professional
          ...
          <Link to="/notfound">
            <div className="picture-text">
              ...
              <div id="caption">
                ...
                league that consists of 32 teams. The NFL is one of the major
                North American professional sports leagues and the highest
                professional level of American football in the world.{" "}
              </div>
            </div>
        ...
        <div className="picture-one">
          <Link to="/footballpage">
            ...
            <div className="picture-text">
              ...
              <div id="caption">
                Esports, short for electronic sports, is a form of competition
                using video games. Esports often takes the form of organized,
          ...
          <Link to="/footballpage">
            ...
            <div className="picture-text">
              ...
              <div id="caption">
                ...
                international sporting events featuring summer and winter sports
                competitions in which thousands of athletes from around the
                world participate in a variety of competitions. The Olympic
        ...
        <div className="picture-two">
          ...
          <Link to="/notfound">
            <div className="picture-text">
              ...
              <div id="caption">
                Ice hockey is a contact winter team sport played on ice skates,
                usually on an ice skating rink with lines and markings specific
                to the sport.{" "}
              </div>
            </div>
            <img src={esportsLogo} alt="Esports Logo" className="logo"></img>
