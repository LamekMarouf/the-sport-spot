    ...
    <>
      {loading ? (
        <div className="loader">
          <SyncLoader size={10} color={"#8c799e"} loading={loading} />
        </div>
      ) : (
            ...
            <Link to="/footballpage">
              ...
              <div className="picture-text">
                ...
                <div id="caption">
                  ...
                  basketball league in North America. The league is composed of
                  30 teams and is one of the major professional sports leagues
                  in the United States and Canada. It is the premier men's
            ...
            <Link to="/notfound">
              <div className="picture-text">
                ...
                <div id="caption">
                  ...
                  highest professional level of American football in the world.{" "}
                </div>
              </div>
            ...
            <Link to="/footballpage">
              ...
              <div className="picture-text">
                ...
                <div id="caption">
                  ...
                  the world participate in a variety of competitions. The
            ...
            <Link to="/notfound">
              <div className="picture-text">
                ...
                <div id="caption">
                  ...
                  skates, usually on an ice skating rink with lines and markings
